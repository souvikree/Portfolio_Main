  ...
  return (
    ...
    >
      ...
      <div className="section-container relative z-10 py-14 pb-10">
        ...
        {/* Bottom bar */}
        <div
          className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-2 pt-2"
        ...
        >
          ...
          <div className="flex items-center gap-4">
            ...
            >
              <span className="available-dot inline-block mr-1.5" style={{ display: 'inline-block', verticalAlign: 'middle' }} />
              Open to work
            </span>
