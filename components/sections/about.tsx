...
//           if (!activeRef.current) return
//           setLines([]); idx = 0; charIdx = 0; currentText = ''; phase = 'cmd'
...
//       } else {
//         if (phase === 'cmd') { phase = 'out'; charIdx = 0; currentText = ''; timeoutId = setTimeout(type, 200) }
//         else { idx++; phase = 'cmd'; charIdx = 0; currentText = ''; timeoutId = setTimeout(type, 600) }
//       }
//     }
...
//             {line.text}
//             {i === lines.length - 1 && (
//               <motion.span className="inline-block w-2 h-4 ml-0.5 align-middle"
    ...
    >
      ...
      <div className="section-container relative z-10">
        ...
        <div className="grid lg:grid-cols-[420px_1fr] gap-10 lg:gap-14 items-start">
          ...
          >
            ...
            <div className="relative rounded-2xl overflow-hidden group"
              ...
              <motion.div
                ...
                style={{ background: 'conic-gradient(var(--accent), var(--accent-secondary), var(--highlight), var(--accent))', opacity: 0, transition: 'opacity 0.4s' }}
            ...
            {/* Stat counters — these remain from portfolioData (projects, experience, etc.) */}
          ...
          >
            {/* Bio text */}
            <div className="rounded-xl p-6 flex flex-col gap-4 relative overflow-hidden"
              style={{
              ...
              <span className="absolute top-3 right-3 text-[10px] tracking-widest uppercase"
